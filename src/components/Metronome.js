...
var Metronome = React.createClass({
	...
	handleChange: function(event){
		console.log(this.state.value, String(event.target.value))
		this.setState({
    ...
    _init: function() {
        ...
        $('.start').click(function() {
            clearInterval($t);
            $newbpm = 1000 / (this.state.value/60);
    ...
    render: function() {
        return (
			...
			<div className= "row col-md-12">		
				<input type="number" name="bpm" value={this.state.value} onChange={this.handleChange}size="1" />
			</div>
